...
export default function MainList() {
    ...
    useEffect(()=>{
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/new_arrivals/`, {
            method: 'Get',
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/category/fiction`, {
            method: 'Get',
            withCredentials:true,
            cache:'default',
            credentials:'include',
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/category/comics-and-graphics-novels/`, {
            method: 'Get',
            withCredentials:true,
            cache:'default',
            credentials:'include',
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/category/magazines/`, {
            method: 'Get',
            withCredentials:true,
            cache:'default',
            credentials:'include',
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/category/educational-teaching/`, {
            method: 'Get',
            withCredentials:true,
            cache:'default',
            credentials:'include',
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/category/test-preparation/`, {
            method: 'Get',
            withCredentials:true,
            cache:'default',
            credentials:'include',
        ...
        fetch(`${process.env.REACT_APP_API_ULR}/products/category/history_2/`, {
            method: 'Get',
            withCredentials:true,
            cache:'default',
            credentials:'include',
