    ...
    return(
        <div className={classes.mainElement}>
            <Grid container
                  ...
                  spacing='2'
            >
                <Grid item key='1' className={classes.paper}>
                    <ResultBar/>
                </Grid>
                <Grid item key='2' className={classes.paper}>
                    <ResultBar/>
                </Grid>
                <Grid item key='3' className={classes.paper}>
                    <ResultBar/>
                </Grid>
                <Grid item key='1' className={classes.paper}>
                    <ResultBar/>
