        ...
        >
            ...
            <Grid item key='details' className={classes.details}>
                <Grid container
                      ...
                      spacing='0'
                >
                    <Grid item key='bookName' className={classes.bookName} >
                        <h2 >The Prince</h2>
                    </Grid>
                    <Grid item key='Author' className={classes.Author} >
                        <h3 >niccolo machiavelli</h3>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
